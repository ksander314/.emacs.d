;;; tatr.el --- Task tracker over tasks/<HUID>/TASK.md folders -*- lexical-binding: t -*-

;; Vendored from rexim's dotfiles, which is where this file lives now -- it was
;; moved out of the tatr repository itself; see `emacs' in ~/src/tatr/tasks/tags.
;; https://github.com/rexim/dotfiles/blob/master/.emacs.local/tatr.el
;; Fetched 15 Sep 2026.
;;
;; Two things were added and nothing else: the header line above, and the
;; lexical-binding cookie in it, which CLAUDE.md asks of every module here.
;; Local defaults and keys live in init-tatr.el, so refreshing from upstream is
;; a plain overwrite of this file.
